...
function updateTuanIds(url = 'https://cdn.jsdelivr.net/gh/wanthigh/updateJDCode@master/jd_updateFactoryTuanId.json') {
  return new Promise(resolve => {
...
function requireConfig() {
  return new Promise(async resolve => {
    await updateTuanIdsCDN('https://cdn.jsdelivr.net/gh/wanthigh/updateJDCode@master/jd_updateFactoryTuanId.json');
